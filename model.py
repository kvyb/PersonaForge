...
# IF CUDA PRESENT - Uncomment lines where "cuda" is mentioned
...
def build_model_and_tokenizer_for(
    ...
    tokenizer = transformers.AutoTokenizer.from_pretrained(model_name, device_map="auto", max_shard_size="10G")
