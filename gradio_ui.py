    ...
    with gr.Blocks(title="Pygmalion", analytics_enabled=False) as interface:
        ...
        def _run_inference(
            ...
            *char_setting_states,
            ...
            return None, model_history, gradio_history, gradio_history, echo(request)
        ...
        with gr.Tab("Chat Window"):
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    save_char_btn.click(_save_chat_history, inputs=[history_for_model, *char_setting_states], outputs=[chatfile], api_name="SaveHistory")
                with gr.Column():
                    gr.Markdown("""
                        ### To save a chat
    ...
    with gr.Column():
        ...
        with gr.Row():
            with gr.Column():
                ...
                save_char_btn.click(char_file_create, inputs=[char_name, char_persona, char_greeting, world_scenario, example_dialogue], outputs=[charfile], api_name='CharacterCreate')
            with gr.Column():
                gr.Markdown("""
                    ### To save a character
